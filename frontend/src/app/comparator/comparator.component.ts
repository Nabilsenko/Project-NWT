...
export class ComparatorComponent implements OnInit {
    ...
    compare() {
        ...
        if (
            this.cpu_compare_1.name !== undefined &&
            this.cpu_compare_2.name !== undefined
        ) {
            ...
            if (difference < 0) {
                this.result =
                    this.cpu_compare_1.brand?.concat(
                        ' ',
                        this.cpu_compare_1.name
                    ) +
                    ' is ' +
                    this.percentPositif(difference) +
                    '% Better than ' +
                    this.cpu_compare_2.brand?.concat(
                        ' ',
                        this.cpu_compare_2.name
                    ) +
                    '!!';
